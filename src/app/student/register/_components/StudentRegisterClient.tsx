...
import PhotoUploadCard from './photo-upload';
import RegistrationInfoSection from './registration-info';
...
import { FormData, initialForm, fallbackBranchNames, fallbackStatusNames, fallbackGenderNames, fallbackProvinceNames, fallbackDistrictNames, fallbackSubDistrictNames } from './ui';
